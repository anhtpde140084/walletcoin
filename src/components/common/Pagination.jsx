...
const Pagination = ({ count, paginate, prev, next }) => {
        ...
        <div className="flex items-center justify-center py-10 lg:px-0 sm:px-6 px-4">
            <div className="lg:w-3/5 w-full  flex items-center justify-between border-t border-gray-200">
                <div className="flex items-center pt-3 text-gray-600 hover:text-indigo-700 cursor-pointer">
                    ...
                    <p className="text-sm ml-3 font-medium leading-none" onClick={() => prev()}>Previous</p>
                </div>
                <div className="sm:flex hidden">
                    {
                        pageNumbers.map(number => (
                            <p key={number} className="text-sm font-medium leading-none cursor-pointer text-indigo-700 border-t border-indigo-400 pt-3 mr-4 px-2" onClick={() => paginate(number)}>
                                {number}
                            </p>
                        ))
                    }
                ...
                <div className="flex items-center pt-3 text-gray-600 hover:text-indigo-700 cursor-pointer">
                    <p className="text-sm font-medium leading-none mr-3" onClick={() => next()}>Next</p>
                    <svg width={14} height={8} viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1.1665 4H12.8332" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" />
